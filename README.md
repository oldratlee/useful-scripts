...
### 示例
* ./pro.sh ustc ustc2013 "ls -la"
* ./pro.sh ustc ustc2013 "./inm-bigdata-worker-1.0.0-SNAPSHOT/bin/server.sh start"
* ./pro.sh ustc ustc2013 "./inm-bigdata-worker-1.0.0-SNAPSHOT/bin/server.sh stop &"
